<template>
  <div>
    <t-typography-paragraph><t-typography-text>TDesign (primary)</t-typography-text></t-typography-paragraph>
    <t-typography-paragraph
      ><t-typography-text theme="secondary">TDesign (secondary)</t-typography-text></t-typography-paragraph
    >
    <t-typography-paragraph><t-typography-text disabled>TDesign (disabled)</t-typography-text></t-typography-paragraph>
    <t-typography-paragraph
      ><t-typography-text theme="success">TDesign (success)</t-typography-text></t-typography-paragraph
    >
    <t-typography-paragraph
      ><t-typography-text theme="warning">TDesign (warning)</t-typography-text></t-typography-paragraph
    >
    <t-typography-paragraph
      ><t-typography-text theme="error">TDesign (error)</t-typography-text></t-typography-paragraph
    >
    ...
    <t-typography-paragraph
      ><t-typography-text underline>TDesign (underline)</t-typography-text></t-typography-paragraph
    >
