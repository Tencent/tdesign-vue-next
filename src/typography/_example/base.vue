<template>
  <div>
    ...
    <t-typography-text mark
      >TDesign is an enterprise-level design system accumulated by Tencent's various business teams.</t-typography-text
    >
    <t-typography-paragraph
      ...
      with business requirements.</t-typography-paragraph
    >
    <t-typography-title>Comprehensive</t-typography-title>
    <t-typography-paragraph
      >TDesign Support<t-typography-text code>Vue 2</t-typography-text>,<t-typography-text code>Vue 3</t-typography-text
      >,<t-typography-text code>React</t-typography-text>components for Desktop Application and<t-typography-text code
        >Vue 3</t-typography-text
      >,<t-typography-text code>Wechat MiniProgram</t-typography-text>components for Mobile
      Application.</t-typography-paragraph
    >
    <t-typography-paragraph>
      <blockquote>
