...
describe('Popup', () => {
  ...
  describe(':props', () => {
    ...
    it(':overlayInnerStyle', async () => {
      ...
      expect(
        (document.querySelector(`${POPUPClASS}__content`) as HTMLDivElement).style.cssText.includes('666px'),
      ).toEqual(true);
    });
    ...
    it(':overlayStyle', async () => {
      ...
      await wrapper.setProps({
        overlayStyle(triggerEl: Element, overlayEl: Element) {
    ...
    it(':zIndex', async () => {
      ...
      expect(
        (document.querySelector(`${POPUPClASS}`) as HTMLDivElement).style.cssText.includes(String(zIndex)),
      ).toEqual(true);
    });
  });
  describe('@event', () => {
