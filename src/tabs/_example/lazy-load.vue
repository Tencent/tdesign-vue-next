<template>
  <t-space direction="vertical" size="large">
    <t-tabs v-model="value" :lazy-load="true">
      <t-tab-panel :value="1" label="选项卡1" :destroy-on-hide="true">
      ...
      <t-tab-panel :value="3" label="选项卡3" :panel="panelRender" :destroy-on-hide="true" />
    </t-tabs>
  </t-space>
</template>
