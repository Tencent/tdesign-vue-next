<template>
  <t-space direction="vertical">
    ...
    <t-space break-line>
      ...
      <icon-font name="numbers-1-1" style="color: var(--td-brand-color-5)" />
      <icon-font name="numbers-1" style="color: var(--td-brand-color-6)" />
      <icon-font name="numbers-9" style="color: var(--td-brand-color-7)" />
      <icon-font name="numbers-7" style="color: var(--td-brand-color-8)" />
    </t-space>
  </t-space>
</template>
<script setup>
