...
export interface TdStepsProps {
   ...
   * 当前步骤发生变化时触发
   */
  onChange?: (current: StepsCurrent, previous: StepsCurrent, context?: { e?: MouseEvent }) => void;
}

export type StepsCurrent = string | number;
