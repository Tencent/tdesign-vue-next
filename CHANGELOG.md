...
## 🌈 1.6.2 `2023-10-12` 
### 🚀 Features
- `CheckTag`: 支持多种风格标签配置 @chaishi ([#3419](https://github.com/Tencent/tdesign-vue-next/pull/3419))
- `CheckTagGroup`: 支持标签组选择 @chaishi ([#3419](https://github.com/Tencent/tdesign-vue-next/pull/3419))
### 🐞 Bug Fixes
