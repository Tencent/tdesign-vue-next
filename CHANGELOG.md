...
- `Icon`: 新增有序列表图标 `list-numbered`，优化`lock-off`的绘制路径 @uyarn ([#4378](https://github.com/Tencent/tdesign-vue-next/pull/4378))
...
- `DateRangePicker`: 修复在`Form`表单处于禁用时，禁用不生效 @liweijie0812 ([#4380](https://github.com/Tencent/tdesign-vue-next/pull/4380))
...
- `Table`: 修复 `thClassName` 不支持函数和数组使用的缺陷 @theBestVayne ([#4406](https://github.com/Tencent/tdesign-vue-next/pull/4406))
### 🚧 Others
- `Table`: 修复文档文案错误 @Tsuj100 ([#4384](https://github.com/Tencent/tdesign-vue-next/pull/4384))
- `Table`: 修复文档文案错误 @Tsuj100 ([#4384](https://github.com/Tencent/tdesign-vue-next/pull/4384))
