...
inputProps | Object | - | 透传 Input 输入框组件全部属性。TS 类型：`InputProps` `import { InputProps, InputValue } from '@Input'`。[详细类型定义](https://github.com/Tencent/tdesign-vue-next/tree/develop/src/select-input/type.ts) | N
...
popupProps | Object | - | 透传 Popup 浮层组件全部属性。TS 类型：`popupProps` `import { PopupProps } from '@Popup'`。[详细类型定义](https://github.com/Tencent/tdesign-vue-next/tree/develop/src/select-input/type.ts) | N
...
tagInputProps | - | - | 透传 TagInput 组件全部属性。TS 类型：`TagInputProps` `import { TagInputProps } from '@TagInput'`。[详细类型定义](https://github.com/Tencent/tdesign-vue-next/tree/develop/src/select-input/type.ts) | N
tagProps | Object | - | 透传 Tag 标签组件全部属性。TS 类型：`TagProps` `import { TagProps } from '@Tag'`。[详细类型定义](https://github.com/Tencent/tdesign-vue-next/tree/develop/src/select-input/type.ts) | N
...
onChange | Function |  | TS 类型：`(value: SelectInputValue, context: SelectInputChangeContext) => void`<br/>值变化时触发，参数 `trigger` 表示数据变化的触发来源。[详细类型定义](https://github.com/Tencent/tdesign-vue-next/tree/develop/src/select-input/type.ts)。<br/>`type SelectInputChangeContext = TagInputChangeContext`<br/><br/>`import { TagInputChangeContext } from '@TagInput'`<br/> | N
...
change | `(value: SelectInputValue, context: SelectInputChangeContext)` | 值变化时触发，参数 `trigger` 表示数据变化的触发来源。[详细类型定义](https://github.com/Tencent/tdesign-vue-next/tree/develop/src/select-input/type.ts)。<br/>`type SelectInputChangeContext = TagInputChangeContext`<br/><br/>`import { TagInputChangeContext } from '@TagInput'`<br/>
