...
history | Boolean | false | 是否带搜索历史记录 | N
...
suggestions | String[] / Suggestion({value: string, [key: string]: any})[] | - | 联想建议选项 | N
showIcon | Boolean | true | 是否显示搜索图标 | N 
