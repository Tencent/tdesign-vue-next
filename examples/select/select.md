...
value | String / Number / Object / Array | - | 选中值。支持语法糖 `v-model:value`。TS 类型：`SelectValue`。[详细类型定义](https://github.com/Tencent/tdesign-vue-next/tree/develop/src/select/type.ts) | N
