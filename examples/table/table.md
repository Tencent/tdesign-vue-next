...
columnControllerContent | String / Slot / Function | - | 【开发中】自定义显示列控制器的内容呈现，可以填充任意内容。TS 类型：`string | TNode`。[通用类型定义](https://github.com/Tencent/tdesign-vue-next/blob/develop/src/common.ts) | N
