...
名称 | 类型 | 默认值 | 说明 | 必传
-- | -- | -- | -- | --
allowResizeColumnWidth | Boolean | false | 【开发中】是否允许调整列宽 | N
...
footerAffixedBottom | Boolean | false | 【开发中】表尾吸底 | N
footerAffixProps | Object | - | 【开发中】表尾吸底基于 Affix 组件开发，透传全部 Affix 组件属性。TS 类型：`AffixProps` | N
