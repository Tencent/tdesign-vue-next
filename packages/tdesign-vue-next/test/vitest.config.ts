...
import { joinCommonRoot, joinComponentsRoot, joinTdesignVueNextRoot } from '@tdesign/internal-utils';

export default defineConfig({
  resolve: {
    alias: {
      // TODO: paopao 为什么还需要 alias，因为在 example 中的写法只能是 tdesign-vue-next，虽然有这个子应用，但没有 build 是没用的，同时即便是 prebuild 了，hmr 也是问题
      '@tdesign/common-js': await joinCommonRoot('js'),
      '@tdesign/common-style': await joinCommonRoot('style'),
