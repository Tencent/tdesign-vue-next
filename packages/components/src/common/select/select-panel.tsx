...
import type { SelectOption, SelectOptionGroup, TdOptionProps } from '@td/intel/components/select/type';
import TdSelectProps from '@td/intel/components/select/props';
