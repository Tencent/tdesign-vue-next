...
import props from '@td/intel/components/avatar/props';
import type { TdAvatarProps } from '@td/intel/components/avatar//type';
import { usePrefixClass, useCommonClassName, useContent, useTNodeJSX } from '@td/adapter-hooks';
