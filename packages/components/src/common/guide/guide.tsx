import { H, Teleport, computed, defineComponent, nextTick, onMounted, ref, toRefs, watch } from '@td/adapter-vue';
  ...
  setup(props: TdGuideProps, context) {
    ...
    return () => {
      ...
      const renderPopupGuide = () => {
        ...
        const innerClassName: TdPopupProps['overlayInnerClassName'] = [
          {
