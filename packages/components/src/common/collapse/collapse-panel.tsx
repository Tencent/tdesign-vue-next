...
import props from '@td/intel/components/collapse/collapse-panel-props';
import type { CollapseValue, TdCollapsePanelProps } from '@td/intel/components/collapse/type';
