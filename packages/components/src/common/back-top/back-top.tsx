...
import { useChildSlots, usePrefixClass, useContent, useGlobalIcon } from '@td/adapter-hooks';
import props from '@td/intel/components/back-top/props';
...
export default defineComponent({
  ...
  setup(props: TdBackTopProps) {
    ...
    const classPrefix = usePrefixClass('alert');
