...
import { useConfig, usePrefixClass,useGlobalIcon,useTeleport,useTNodeJSX, useContent } from '@td/adapter-hooks';
import { isServer } from '@td/adapter-utils';
import { getScrollbarWidth } from '@td/shared/_common/js/utils/getScrollbarWidth';
import props from '@td/intel/components/drawer/props';
// import { useAction } from '../dialog/hooks';
import { useDrag } from './hooks';

import type { TdDrawerProps, DrawerCloseContext } from '@td/intel/components/drawer/type';
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const sizeValue = computed(() => {
      ...
      // TODO: after global config completed, remove `?? medium`
      const size = props.size ?? globalConfig.value.size ?? 'medium';
