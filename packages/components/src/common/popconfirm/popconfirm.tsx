...
import type { PopconfirmVisibleChangeContext } from '@td/intel/components/popconfirm/type';
import props from '@td/intel/components/popconfirm/props';
...
import type { PopupVisibleChangeContext, TdPopupProps } from '@td/intel/components/popup/type';
  ...
  setup(props) {
    ...
    const innerPopupProps = computed(() => {
      return {
        ...
        trigger: 'click' as TdPopupProps['trigger'],
        destroyOnClose: props.destroyOnClose,
        placement: props.placement,
        ...(props.popupProps as TdPopupProps),
      };
    });
