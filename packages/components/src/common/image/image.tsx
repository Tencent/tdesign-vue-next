...
import { useTNodeDefault, useTNodeJSX, useConfig, useImagePreviewUrl, usePrefixClass } from '@td/adapter-hooks';

import type { TdImageProps } from '@td/intel/components/image/type';
import props from '@td/intel/components/image/props';
...
export default defineComponent({
  ...
  setup(props: TdImageProps) {
    ...
    const { globalConfig } = useConfig('image');
    // VUE23:*
