...
import type { PrimaryTableCellParams, PrimaryTableCol, TableRowData, TdPrimaryTableProps } from '@td/intel/components/table/type';
import type { ScrollToElementParams } from '@td/adapter-hooks';
import type { PageInfo } from '@td/intel/components/pagination/type';
      ...
      for (let i = 0, len = columns.length; i < len; i++) {
        ...
        if (item.sorter || item.filter) {
          ...
          item.title = (h, p) => {
            ...
            // @ts-expect-error 注意：此处 Vue2 和 Vue3 有所不同
