...
loop | Boolean | true | \- | N
navigation | Boolean / Slot / Function | true | navigation config。Typescript：`TNode \| Boolean`。[see more ts definition](https://github.com/Tencent/tdesign-vue-next/blob/develop/packages/components/common.ts) | N
