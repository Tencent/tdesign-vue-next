...
navigation | Boolean / Slot / Function | true | 导航器全部配置。TS 类型：`TNode \| Boolean`。[通用类型定义](https://github.com/Tencent/tdesign-vue-next/blob/develop/packages/components/common.ts) | N
