...
export default defineComponent({
  ...
  //     <CloseCircleFilledIcon class={CLEAR_CLASS} onClick={onClearClick} />
  //   ) : (
  //     renderTNodeJSX('suffixIcon')
  //   );
  //   const prefixIconNode = renderTNodeJSX('prefixIcon');
  //   const suffixClass = `${classPrefix}-tag-input__with-suffix-icon`;
  //   if (suffixIconNode && !classes.includes(suffixClass)) {
  //     classes.push(suffixClass);
  //   }
  //   // 自定义 Tag 节点
  //   const displayNode = renderTNodeJSX('valueDisplay', {
  //     params: {
  ...
  //   const label = renderTNodeJSX('label', { silent: true });
  //   const inputProps = inputProps as TdTagInputProps['inputProps'];
  //   const readonly = isReadonly || inputProps?.readonly;
  //   return (
  //     <TInput
  //       ref="tagInputRef"
  //       v-slots={{
  ...
  //       onCompositionstart={onInputCompositionstart}
  //       onCompositionend={onInputCompositionend}
  //       {...(inputProps as TdTagInputProps['inputProps'])}
  //     />
  //   );
  // },
});
