...
isInput | Boolean | true | whether the trigger shows the color value input. When `false`, only the color block is displayed and the text is hidden, without affecting other interactions. Only works for the default trigger | N
