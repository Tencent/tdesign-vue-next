...
**AG-UI（Agent User Interaction Protocol）** 是专为 AI Agent 与前端应用交互设计的标准化协议。它建立了一套统一的通信规范，让前端界面能够与各种 AI 服务无缝对话，就像是 AI 应用的"通用语言"。
...
AG-UI 定义了 16 种标准事件类型，覆盖 AI 交互的完整生命周期：
...
详细的使用方法请参考[ChatBot 组件文档](/chat/components/chatbot#agui)。
...
- [TDesign Chat 组件文档](/chat/components/chatbot)
- [快速开始指南](/chat/docs/getting-started)
