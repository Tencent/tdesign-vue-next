const componentDocs = [
  {
    ...
    component: () => import('@tdesign/pro-components-chat/chatbot.md'),
  },
  {
    title: 'Chat 对话',
    titleEn: 'Chat',
  ...
  },
  {
    ...
    component: () => import('@tdesign/pro-components-chat/attachments.md'),
  },
  {
    ...
    component: () => import('@tdesign/pro-components-chat/fileCard.md'),
  },
];
