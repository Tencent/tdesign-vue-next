    ...
    children: [
      {
        ...
        componentEn: () => import('@/packages/@tdesign-vue-next/chat/site/docs/getting-started.en-US.md'),
      },
      {
        title: '最佳实践',
        titleEn: 'Starter Kit',
        ...
        component: () => import('@/packages/@tdesign-vue-next/chat/site/docs/starter.md'),
        componentEn: () => import('@/packages/@tdesign-vue-next/chat/site/docs/starter.en-US.md'),
      },
      {
        title: '更新日志',
        titleEn: 'CHANGELOG',
    ...
    children: [
      {
        ...
        componentEn: () => import('tdesign-vue-next/button/button.en-US.md'),
      },
      {
        title: 'Icon 图标',
        titleEn: 'Icon',
        ...
        componentEn: () => import('tdesign-vue-next/icon/icon.en-US.md'),
      },
      {
        title: 'Link 链接',
        titleEn: 'Link',
    ...
    children: [
      {
        ...
        componentEn: () => import('tdesign-vue-next/divider/divider.en-US.md'),
      },
      {
        title: 'Grid 栅格',
        titleEn: 'Grid',
        ...
        componentEn: () => import('tdesign-vue-next/grid/grid.en-US.md'),
      },
      {
        title: 'Layout 布局',
        titleEn: 'Layout',
        ...
        componentEn: () => import('tdesign-vue-next/layout/layout.en-US.md'),
      },
      {
        title: 'Space 间距',
        titleEn: 'Space',
    ...
    children: [
      {
        ...
        componentEn: () => import('tdesign-vue-next/affix/affix.en-US.md'),
      },
      {
        title: 'Anchor 锚点',
        titleEn: 'Anchor',
        ...
        componentEn: () => import('tdesign-vue-next/anchor/anchor.en-US.md'),
      },
      {
        title: 'BackTop 回到顶部',
        titleEn: 'BackTop',
      ...
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/breadcrumb/breadcrumb.en-US.md'),
      },
      {
        title: 'Dropdown 下拉菜单',
        titleEn: 'Dropdown',
        ...
        componentEn: () => import('tdesign-vue-next/dropdown/dropdown.en-US.md'),
      },
      {
        title: 'Menu 导航菜单',
        titleEn: 'Menu',
        ...
        componentEn: () => import('tdesign-vue-next/menu/menu.en-US.md'),
      },
      {
        title: 'Pagination 分页',
        titleEn: 'Pagination',
        ...
        componentEn: () => import('tdesign-vue-next/pagination/pagination.en-US.md'),
      },
      {
        title: 'Steps 步骤条',
        titleEn: 'Steps',
        ...
        componentEn: () => import('tdesign-vue-next/steps/steps.en-US.md'),
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/sticky-tool/sticky-tool.en-US.md'),
      },
      {
        title: 'Tabs 选项卡',
        titleEn: 'Tabs',
        ...
        componentEn: () => import('tdesign-vue-next/tabs/tabs.en-US.md'),
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        componentEn: () => import('tdesign-vue-next/auto-complete/auto-complete.en-US.md'),
      },
      {
        title: 'Cascader 级联组件',
        titleEn: 'Cascader',
        ...
        componentEn: () => import('tdesign-vue-next/cascader/cascader.en-US.md'),
      },
      {
        title: 'Checkbox 多选框',
        titleEn: 'Checkbox',
        ...
        componentEn: () => import('tdesign-vue-next/checkbox/checkbox.en-US.md'),
      },
      {
      ...
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/date-picker/date-picker.en-US.md'),
      },
      {
        title: 'Form 表单',
        titleEn: 'Form',
        ...
        componentEn: () => import('tdesign-vue-next/form/form.en-US.md'),
      },
      {
        title: 'Input 输入框',
        titleEn: 'Input',
        ...
        componentEn: () => import('tdesign-vue-next/input/input.en-US.md'),
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/input-adornment/input-adornment.en-US.md'),
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/input-number/input-number.en-US.md'),
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/tag-input/tag-input.en-US.md'),
      },
      {
        title: 'Radio 单选框',
        titleEn: 'Radio',
        ...
        componentEn: () => import('tdesign-vue-next/radio/radio.en-US.md'),
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/range-input/range-input.en-US.md'),
      },
      {
        title: 'Select 选择器',
        titleEn: 'Select',
        ...
        componentEn: () => import('tdesign-vue-next/select/select.en-US.md'),
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/select-input/select-input.en-US.md'),
      },
      {
        title: 'Slider 滑块',
        titleEn: 'Slider',
        ...
        componentEn: () => import('tdesign-vue-next/slider/slider.en-US.md'),
      },
      {
        title: 'Switch 开关',
        titleEn: 'Switch',
        ...
        componentEn: () => import('tdesign-vue-next/switch/switch.en-US.md'),
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/textarea/textarea.en-US.md'),
      },
      {
        title: 'Transfer 穿梭框',
        titleEn: 'Transfer',
        ...
        componentEn: () => import('tdesign-vue-next/transfer/transfer.en-US.md'),
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/time-picker/time-picker.en-US.md'),
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/tree-select/tree-select.en-US.md'),
      },
      {
        title: 'Upload 上传',
        titleEn: 'Upload',
        ...
        componentEn: () => import('tdesign-vue-next/upload/upload.en-US.md'),
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        componentEn: () => import('tdesign-vue-next/avatar/avatar.en-US.md'),
      },
      {
        title: 'Badge 徽标',
        titleEn: 'Badge',
        ...
        componentEn: () => import('tdesign-vue-next/badge/badge.en-US.md'),
      },
      {
        title: 'Calendar 日历',
        titleEn: 'Calendar',
        ...
        componentEn: () => import('tdesign-vue-next/calendar/calendar.en-US.md'),
      },
      {
        title: 'Card 卡片',
        titleEn: 'Card',
        ...
        componentEn: () => import('tdesign-vue-next/card/card.en-US.md'),
      },
      {
        title: 'Collapse 折叠面板',
        titleEn: 'Collapse',
        ...
        componentEn: () => import('tdesign-vue-next/collapse/collapse.en-US.md'),
      },
      {
        title: 'Comment 评论',
        titleEn: 'Comment',
      ...
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/image-viewer/image-viewer.en-US.md'),
      },
      {
        title: 'List 列表',
        titleEn: 'List',
        ...
        componentEn: () => import('tdesign-vue-next/list/list.en-US.md'),
      },
      {
        title: 'Loading 加载',
        titleEn: 'Loading',
        ...
        componentEn: () => import('tdesign-vue-next/loading/loading.en-US.md'),
      },
      {
        title: 'Progress 进度条',
        titleEn: 'Progress',
        ...
        componentEn: () => import('tdesign-vue-next/progress/progress.en-US.md'),
      },
      {
        title: 'Skeleton 骨架屏',
        titleEn: 'Skeleton',
      ...
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/swiper/swiper.en-US.md'),
      },
      {
        title: 'Table 表格',
        titleEn: 'Table',
        ...
        componentEn: () => import('tdesign-vue-next/table/table.en-US.md'),
      },
      {
        title: 'Tag 标签',
        titleEn: 'Tag',
        ...
        componentEn: () => import('tdesign-vue-next/tag/tag.en-US.md'),
      },
      {
        title: 'Timeline 时间轴',
        titleEn: 'Timeline',
        ...
        componentEn: () => import('tdesign-vue-next/timeline/timeline.en-US.md'),
      },
      {
        title: 'Tooltip 文字提示',
        titleEn: 'Tooltip',
        ...
        componentEn: () => import('tdesign-vue-next/tooltip/tooltip.en-US.md'),
      },
      {
        title: 'Tree 树',
        titleEn: 'Tree',
        ...
        componentEn: () => import('tdesign-vue-next/tree/tree.en-US.md'),
      },
      {
        title: 'Watermark 水印',
        titleEn: 'Watermark',
        ...
        componentEn: () => import('tdesign-vue-next/watermark/watermark.en-US.md'),
      },
      {
        title: 'Rate 评分',
        titleEn: 'Rate',
        ...
        componentEn: () => import('tdesign-vue-next/rate/rate.en-US.md'),
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        componentEn: () => import('tdesign-vue-next/alert/alert.en-US.md'),
      },
      {
        title: 'Dialog 对话框',
        titleEn: 'Dialog',
        ...
        componentEn: () => import('tdesign-vue-next/dialog/dialog.en-US.md'),
      },
      {
        title: 'Drawer 抽屉',
        titleEn: 'Drawer',
        ...
        componentEn: () => import('tdesign-vue-next/drawer/drawer.en-US.md'),
      },
      {
        title: 'Guide 引导',
        titleEn: 'Guide',
      ...
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/message/message.en-US.md'),
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/notification/notification.en-US.md'),
      },
      {
        ...
        componentEn: () => import('tdesign-vue-next/popconfirm/popconfirm.en-US.md'),
      },
      {
        title: 'Popup 弹出层',
        titleEn: 'Popup',
        ...
        componentEn: () => import('tdesign-vue-next/popup/popup.en-US.md'),
      },
    ],
  },
];
