...
const renderHeader = (status) => {
  console.log('flag======:', status === 'streaming', title.value);
...
const handelLayoutChange = (value) => {
  console.error('handelLayoutChange=====:', value);
  layout.value = value;
};
const handelAnimationChange = (value) => {
  console.error('handelAnimationChange=====:', value);
...
<template>
  <t-space direction="vertical">
    <t-space>
      ...
      <t-space direction="vertical">
        <h5>animation：</h5>
        <t-radio-group :default-value="animation" @change="handelAnimationChange">
    ...
    <t-chat-reasoning
      ...
      :collapsed="status.value === 'streaming'"
      :animation="animation"
