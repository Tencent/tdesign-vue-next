...
export interface TdBaseTableProps<T extends TableRowData = TableRowData> {
   ...
   * @deprecated
   */
  footerAffixProps?: Partial<TdAffixProps>;
  /**
   ...
   * @default false
   */
  footerAffixedBottom?: boolean | Partial<TdAffixProps>;
  /**
   * 表尾总结行
   */
   ...
   * @deprecated
   */
  headerAffixProps?: Partial<TdAffixProps>;
  /**
   ...
   * @default false
   */
  headerAffixedTop?: boolean | Partial<TdAffixProps>;
  /**
   ...
   */
  horizontalScrollAffixedBottom?: boolean | Partial<TdAffixProps>;
  /**
   * 是否显示鼠标悬浮状态
   * @default false
   */
   ...
   * 透传加载组件全部属性
   */
  loadingProps?: Partial<TdLoadingProps>;
  /**
   * 语言配置
   */
  locale?: TableConfig;
   ...
   */
  pagination?: TdPaginationProps;
  /**
   * 分页吸底。基于 Affix 组件开发，透传全部 Affix 组件属性
   */
  paginationAffixedBottom?: boolean | Partial<TdAffixProps>;
  /**
...
export interface BaseTableCol<T extends TableRowData = TableRowData> {
  ...
  ellipsis?:
    ...
    | TdTooltipProps
    | { props: TdTooltipProps; content: TNode<BaseTableCellParams<T>> };
  /**
  ...
  ellipsisTitle?:
    ...
    | TdTooltipProps
    | { props: TdTooltipProps; content: TNode<BaseTableColParams<T>> };
  /**
   * 固定列显示位置
   * @default left
   */
...
export type CheckProps<T> =
  | TdCheckboxProps
  | TdRadioProps
  | ((options: { row: T; rowIndex: number }) => TdCheckboxProps | TdRadioProps);
...
export type FilterProps = TdRadioProps | TdCheckboxProps | TdInputProps | { [key: string]: any };
