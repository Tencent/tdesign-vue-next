...
const level1Count = computed(() => parseInt(textLevel1Count.value, 10) || 1);
const level2Count = computed(() => parseInt(textLevel2Count.value, 10) || 1);
const level3Count = computed(() => parseInt(textLevel3Count.value, 10) || 1);
