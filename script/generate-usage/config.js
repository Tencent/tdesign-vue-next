...
module.exports = {
  button: {
    render: `<t-button v-bind="configProps">确定</t-button>`,
  },
  divider: {
    render: `<div :style="{ width: '200px' }">
    <span>正直</span>
  ...
  alert: {
    render: `<t-alert message="这是一条信息" v-bind="configProps" />`,
  },
  anchor: {
    render: `<t-anchor v-bind="configProps">
  ...
  'color-picker': {
    render: `<t-color-picker-panel
    v-bind="configProps"
  />`,
  },
  calendar: {
    render: `<t-calendar v-bind="configProps" />`,
  },
  'date-picker': {
    render: `<t-date-picker v-bind="configProps" />`,
  },
  dropdown: {
    render: `<t-dropdown :options="[{ content: '操作一', value: 1 }, { content: '操作二', value: 2 }]" v-bind="configProps">
    <t-button>更多...</t-button>
  </t-dropdown>`,
  },
  menu: {
    render: `<div :style="{ padding: '24px', background: 'var(--bg-color-page)', borderRadius: '3px' }">
  ...
  steps: {
    render: `<t-steps :current="1" v-bind="configProps">
  ...
  tabs: {
    render: `<div class="tdesign-demo-block-column-large">
    <t-tabs v-model="value" v-bind="configProps">
  ...
  checkbox: {
    render: `<t-checkbox v-bind="configProps">基础多选框</t-checkbox>`,
  },
  form: {
    render: `<t-form v-bind="configProps">
  ...
  input: {
    render: `<t-input v-bind="configProps" />`,
  },
  'input-number': {
    render: `<t-input-number v-bind="configProps"/>`,
  },
  radio: {
    render: `<t-radio v-bind="configProps">单选框</t-radio>`,
  },
  select: {
    render: `
  ...
  'select-input': {
    render: `<t-select-input panel="暂无数据" tips="这是 tips 文本信息" v-bind="configProps" />`,
  },
  slider: {
    render: `<t-slider v-bind="configProps" />`,
  },
  switch: {
    render: `<t-switch v-bind="configProps" />`,
  },
  'tag-input': {
    render: `<t-tagInput v-bind="configProps" />`,
  },
  textarea: {
    render: `<t-textarea placeholder="请输入内容" v-bind="configProps" />`,
  },
  'tree-select': {
    render: `<t-tree-select v-bind="configProps"
        :data="[{
            label: '广东省',
            value: 'guangdong',
            children: [{
  ...
  'time-picker': {
    render: `<t-timePicker v-bind="configProps" />`,
  },
  upload: {
    render: `<t-upload action="https://service-bv448zsw-1257786608.gz.apigw.tencentcs.com/api/upload-demo" v-bind="configProps" />`,
  },
  avatar: {
    render: `
  ...
  badge: {
    render: `<t-badge count="100" v-bind="configProps">
    <t-button>按钮</t-button>
  </t-badge>`,
  },
  list: {
    render: `<t-list v-bind="configProps">
    <t-list-item>
  ...
  loading: {
    render: `<t-loading v-bind="configProps" />`,
  },
  progress: {
    render: `
  ...
  skeleton: {
    render: `<t-skeleton v-bind="configProps">
  ...
  tag: {
    render: `<t-tag v-bind="configProps">标签</t-tag>`,
  },
  tooltip: {
    render: `<t-tooltip content="这是Tooltip内容" v-bind="configProps">
            <t-button>hover me</t-button>
          </t-tooltip>`,
  },
  tree: {
    render: `<t-tree :data="[{ label: '第一段',
  ...
  message: {
    render: `<t-message v-bind="configProps" duration="0" content="这里是 Message 信息"  :closeBtn="true" />`,
  },
  notification: {
    render: `<t-notification v-bind="configProps" duration="0" title="标题名称" content="这是一条消息通知" :closeBtn="true" />`,
  },
  popconfirm: {
    render: `<t-popconfirm v-bind="configProps" content="确认删除吗">
            <t-button>删除</t-button>
        </t-popconfirm>`,
  },
  popup: {
    render: `<t-popup content="这是一个弹出框" v-bind="configProps">
  <t-button>按钮</t-button>
</t-popup>`,
  },
};
